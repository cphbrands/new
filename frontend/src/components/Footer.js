  ...
  const handleNewsletterSubmit = (e) => {
    ...
    if (email) {
      toast({
        ...
        description: "Du vil nu modtage vores nyhedsbrev.",
      });
      setEmail('');
    }
  };
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-1">Fri Levering 2-5 hverdage</h3>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-1">Sikker betaling</h3>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold mb-1">Udvidet retur</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-zinc-600 text-sm mb-4">
              Få ekslusive tilbud og nyheder direkte i din indbakke.
            </p>
